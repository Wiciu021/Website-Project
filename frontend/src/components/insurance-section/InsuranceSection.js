      ...
      <div className='insurance-wrapper'>
        ...
        <div className='content-container'>
          <div className='insurance-option'>
            ...
            <a href="https://klient.interrisk.pl/EduPlusOnline?u=9elggpd8tz" rel="noreferrer noopener" target='_blank' className='link-button'>Przejdz do oferty</a>
          </div>
          <div className='insurance-option'>
            ...
            <a href="https://szkola.compensa.pl/" rel='noreferrer noopener' target='_blank' className='link-button'>Przejdz do oferty</a>
          </div>
        </div>
      </div>
    </section>
